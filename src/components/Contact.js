...
const Contact = () => {
  ...
  const onSubmit = (e) => {
    ...
    if (
      ...
      emailjs
        .send(
          "service_7w4ak2t", // service id
          "template_0soi0ao", // template id
          mailData,
          "w62qil91AtYd6hOca" // public api
        )
        .then(
          (response) => {
            setError(false);
          ...
          <div className="col-lg-5 col-xl-4 m-15px-tb">
            <div className="contact-info">
              ...
              <ul>
                <li className="media">
                  <i className="ti-map" />
                  <span className="media-body">Porto Alegre, Brasil</span>
                </li>
                <li className="media">
                  <i className="ti-email" />
                  <span className="media-body">machado.profile@gmail.com</span>
                </li>
                <li className="media">
                  <i className="ti-mobile" />
                  <span className="media-body">+55 51 99412-9797</span>
                </li>
              </ul>
            </div>
          </div>
